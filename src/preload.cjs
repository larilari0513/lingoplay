...
const calls = ['bootstrap','save-settings','save-key','check-api','usage','cancel-screen','cancel-chat','list-sources','capture','translate-text','translate-screen','copy','overlay','overlay-content','voice-start','voice-bind','voice-stop','stop-all','open-guide','open-billing','unlock-overlay'];
const events = ['voice-event','usage-update','hotkey','emergency-stop','overlay-visible','overlay-locked','app-warning'];
